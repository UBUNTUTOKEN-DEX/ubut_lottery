...
const config = [
  {
    ...
    description: [
      <Trans>
        ...
        UBUT up to the maximum commit limit, which is published along with the IFO voting proposal. The Private Sale has
        no participation fee.
      </Trans>,
      <Trans>
        In the Public Sale, everyone with an active PancakeSwap profile can commit. However the maximum amount of UBUT
        user can commit, is equal to the average UBUT balance in the IFO UBUT pool prior to the IFO. And there’s a fee
  ...
  },
  {
    ...
    description: [<Trans>The UBUT from the participation fee will be thrown into the weekly token burn.</Trans>],
  },
  {
    title: <Trans>How can I get an achievement for participating in the IFO?</Trans>,
    description: [
      <Trans>You need to contribute a minimum of about 10 USD worth of UBUT to either sale.</Trans>,
      <Trans>
